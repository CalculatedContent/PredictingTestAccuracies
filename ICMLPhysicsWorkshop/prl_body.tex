...
\begin{figure}[H]
   ...
   \michael{CHARLES: more details, here or in text; can't read words on figs, here and elsewhere.}
   }
   \label{fig:alphas}
\end{figure}
...
\michael{CHARELS: What is best ref here.}
...
We can relate our universality metric to the more traditional, data dependent, VC-like Product Norm capacity metric $\mathcal{C}$, defined as
\begin{equation}
...
\begin{figure}[H]
   ...
   \caption{%
    ...
    \michael{CHARELS: do we want another subfigure here, maybe scatter plot of some NLP models.}
   }
   \label{fig:alphahats}
\end{figure}
...
\michael{CHARLES: what is significance of that last comment.}
