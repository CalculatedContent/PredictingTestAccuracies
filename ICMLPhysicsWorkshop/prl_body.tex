...
\begin{figure}[H]
   ...
   \vspace{-3mm}
   \caption{Comparison of unweighted and weighted average Power Law exponent ($\alpha$) vs. reported Top1 Error for 156 pre-trained ImageNet PyTorch/OSMR models.
      }
   \label{fig:alphahats}
\end{figure}
