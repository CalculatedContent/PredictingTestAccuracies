...
\begin{figure}[!htb]
    \centering
    \subfigure[ResNeXt]{
        \includegraphics[scale=0.25]{img/ResNeXt-w_alphas.png} 
        \label{fig:resnet-small}
    }
   \subfigure[MeNet]{
        \includegraphics[scale=0.25]{img/MeNet-w_alphas.png} 
        \label{fig:menet-net}
    }
    '   \subfigure[FDMobileNet]{
        \includegraphics[scale=0.25]{img/FDMobileNet-w_alphas.png} 
        \label{fig:resnet-small}
    }
