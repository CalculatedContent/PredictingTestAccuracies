...
%%MM%% %{To do this, we rely upon the known theoretical results for Heavy tailed random matrices, but we also need to be careful about the normalization we use.}
%%MM%% 
%%MM%% More-so, to demonstrate the effectiveness of the approach, we will test these relations with numerical simulations of Heavy tailed Pareto matrices.
...
\michael{Probably remove this entirely, unless relate to synthetic empirical results.}
