...
We show this metric can be approximated by the  \nred{average  log Frobenius norm}  of the weight matrices $\langle\Vert\\mathbf{W}Vert_F{}\rangle$.
...
Our \nred{motivations lie in} Statistical Physics, and, in particular, the concept of Universality underlying HT-SR (and related HT-RMT techniques).
