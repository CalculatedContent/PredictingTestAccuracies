...
The recent work of Martin and Mahoney~\cite{MM18_TR} used HT-RMT to characterize the Implicit Self-Regularization in well-trained DNNs.
...
\michael{Does this figure do what we need, e.g., justify that we are better than product norm, especially since aside from VGG13, they look pretty good.}
