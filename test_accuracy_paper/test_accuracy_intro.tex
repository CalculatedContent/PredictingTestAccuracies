...
%%SPACE%% \michael{MM TO DO OR REMOVE.}
\end{itemize}
%\vspace{-1mm}
...
\michael{MM still to tweak the rest.}
...
and, accordingly, the generalization capacity, or a wide range of pre-trained DNNs---the power law (PL) exponents, $\alpha$, of the invidual layer weight matrices $\mathbf{W}$,
