...
This complexity metic, $\hat{\alpha}$ of Eqn.~(\ref{eqn:alpha_hat_generic}) or Eqn.~(\ref{eqn:alpha_hat_specific}), is a weighted average of the power law exponents $\alpha$ for each layer weight matrix, where 
