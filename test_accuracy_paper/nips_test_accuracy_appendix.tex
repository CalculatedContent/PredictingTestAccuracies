...
%and given our results here as well as other recent results~\cite{MM18_TR,MM19_HTSR_ICML},
...
Note that in these expressions and the expressions below, we follow previous work \cite{MM18_TR,MM19_HTSR_ICML} and don't compute expressions for $\mu=2$ precisely.
...
Our theory of Implicit Self Regularization used Heavy Tailed Random Matrix Theory (HT RMT), and here we use HT RMT also~\cite{MM18_TR,MM19_HTSR_ICML}.
