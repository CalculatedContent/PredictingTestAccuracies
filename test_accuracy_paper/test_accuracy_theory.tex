...
Frobenius norm behaves very differently from a random Pareto matrix.  Instead of forming a direct relation, we will exploit
Universality.  

We will derive a simple linear relation between the relation he Frobenius norm (squared) $\Vert\mathbf{W}\Vert^{2}_{F}$, the
