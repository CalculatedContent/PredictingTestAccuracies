...
This is an asymptotic relation for the Very Heavy Tailed Universality class, but we will extend it 
into the Fat Tailed Universality class, where it applies for the finite size weight matrices in DNNs.
}
