...
%  Of course, the weight matrices are not actually random because they have been trained on very large, high quality data sets.
%However, our previous analysis shows that the 
...
This leads to a novel linear relation between the Frobenius norm and the power law exponent for our Heavy tailed matrices:
