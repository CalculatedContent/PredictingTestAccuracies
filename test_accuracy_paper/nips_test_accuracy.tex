...
\input{nips_test_accuracy_theory}
\input{nips_test_accuracy_empirical}
\input{nips_test_accuracy_discussion}
...
\appendix
\newpage
\input{nips_test_accuracy_theory1}
\input{nips_test_accuracy_appendix}
